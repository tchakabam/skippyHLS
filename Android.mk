...
LOCAL_SRC_FILES += $(MY_GSTREAMER_HLS_SOURCE_PATH)/skippy_fragment.c $(MY_GSTREAMER_HLS_SOURCE_PATH)/skippy_hlsdemux.c $(MY_GSTREAMER_HLS_SOURCE_PATH)/skippy_m3u8.cpp $(MY_GSTREAMER_HLS_SOURCE_PATH)/skippy_uridownloader.c $(MY_GSTREAMER_HLS_SOURCE_PATH)/skippy_m3u8_parser.cpp $(MY_GSTREAMER_HLS_SOURCE_PATH)/oggOpusdec.cpp $(MY_GSTREAMER_HLS_SOURCE_PATH)/string_utils.cpp
