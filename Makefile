...
$(OBJECT_TARGET): $(C_FILES) $(H_FILES)
	...
	g++ $(GCC_FLAGS) $(GCC_INCLUDE_FLAGS) -o build/skippy_m3u8.o -c src/skippy_m3u8.cpp
	g++ $(GCC_FLAGS) $(GCC_INCLUDE_FLAGS) -o build/SkippyM3UParser.o -c src/SkippyM3UParser.cpp

tests: $(C_FILES_TESTS) lib
	mkdir -p build
	g++ $(GCC_FLAGS) $(GCC_INCLUDE_FLAGS) $(GCC_LIBRARY_FLAGS) -L./build -lskippyhls -o build/SkippyM3UParserTest tests/SkippyM3UParserTest.cpp
